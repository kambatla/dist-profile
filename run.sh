...
# 1. Teragen
sh start-dist-profiling.sh teragen-$1 '/home/kasha/h/hadoop-2.0.0-mr1-cdh4.2.0/bin/hadoop jar /home/kasha/h/hadoop-2.0.0-mr1-cdh4.2.0/hadoop-examples-2.0.0-mr1-cdh4.2.0.jar teragen -Dmapred.map.tasks=480 -Dmapred.reduce.tasks=240 24000000000 teragen-out'
...
sh start-dist-profiling.sh shuffle-compress-$1 '/home/kasha/h/hadoop-2.0.0-mr1-cdh4.2.0/bin/hadoop jar /home/kasha/jars/macrobenchmarks-1.0-SNAPSHOT-jar-with-dependencies.jar com.cloudera.mb.ShuffleText -Dmapred.map.tasks=480 -Dmapred.reduce.tasks=240 -Dmapred.compress.map.output=true -Dmapred.map.output.compression.codec=org.apache.hadoop.io.compress.SnappyCodec 24000000000 shuffle-compress-out'
